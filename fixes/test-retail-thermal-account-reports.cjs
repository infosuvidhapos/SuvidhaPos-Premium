...
assert.ok(html.includes('/js/retail-thermal-reports.js?v=6250'),'Thermal report JS not loaded');
assert.ok(html.includes('/css/retail-thermal-reports.css?v=6250'),'Thermal report CSS not loaded');
