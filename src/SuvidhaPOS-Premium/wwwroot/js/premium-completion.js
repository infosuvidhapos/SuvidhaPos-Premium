...
function manager(){return ['admin','administrator','manager','super admin'].indexOf(role())>=0}
...
w.openPremiumJewelleryItem=async function(id){
 ...
 var modalHost=d.querySelector('#modal');if(modalHost)modalHost.classList.add('premium-jewellery-item-modal');var box=d.querySelector('#modal .modalbox');if(box){box.style.width='min(1180px,96vw)';box.style.maxWidth='1180px'}
