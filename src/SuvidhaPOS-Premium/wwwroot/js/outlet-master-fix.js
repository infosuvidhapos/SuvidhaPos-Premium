      ...
      app.innerHTML=`<div class="content">
        <div class="twocol">
          ...
          <div class="panel outlet-master-panel"><div class="panelhead"><h3>OUTLET MASTER</h3><span class="tag">WEBSITE SYNC</span></div>
            <p class="muted">Store Type aur Validity sirf suvidhapremium.suvidhapos.in se manage hote hain. POS me dono locked hain. Baaki outlet details local edit ho sakti hain aur background sync queue me jaati hain.</p>
            <div class="formgrid">
            ...
            <div class="toolbar" style="margin-top:12px"><button class="btn" onclick="saveOutlet()">Save Outlet Master</button><button class="btn secondary" onclick="syncOutletNowPremium(true)">↻ Sync Now</button><span class="muted">Offline ho to billing/login/print network ka wait nahi karega.</span></div>
          </div>
        </div>
